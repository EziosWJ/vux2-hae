		...
		<div class="evaluation_content evaluation_content2" v-show="active==1">
			...
			<div class="evaluation_list">
				<ul>
					<li>
						<div class="ov">
							<div class="fl persuasion_name">对12001的<span class="color_main">奖励</span></div>
							<div class="fr adjusted_btn"><router-link to="/esultsVisit">详细结果</router-link></div>
						</div>
					</li>
					<li>
						<div class=" ov">
							<div class="fl persuasion_name">对12002的<span class="color_red">惩罚</span></div>
							<div class="fr adjusted_btn"><router-link to="/esultsVisit">详细结果</router-link></div>
						</div>
					</li>
					<li>
						<div class="ov">
							<div class="fl persuasion_name">对12003的<span class="color_main">奖励</span></div>
							<div class="fr adjusted_btn"><router-link to="/esultsVisit">详细结果</router-link></div>
						</div>
					</li>
				</ul>
