<template>
	...
	<div class="evaluation_out leave_out">
		...
		<div class="evaluation_tab">
			<ul>
				<li @click="active=0" :class="{'active':active==0}">新建考察</li>
				<li @click="active=1" :class="{'active':active==1}">考察记录</li>
			</ul>
		</div>
					...
					<li>
						<router-link to="/phome/mindTestResult">
							...
							<div class="adjusted_main">
								<div class="adjusted_text">被考察人：李杰</div>
