<template>
	...
	<div class="evaluation_out leave_out">
		<div class="evaluation_banner">
			<img src="../../../../assets/visit_banner.jpg" />
		</div>
		<div class="evaluation_tab">
			<ul>
				<li @click="active=0" :class="{'active':active==0}">新建反馈</li>
				<li @click="active=1" :class="{'active':active==1}">反馈记录</li>
			</ul>
		</div>
		<div class="evaluation_content " v-show="active==0">			
			<group label-width="5em">
				<div class="diversion_results"><h3>信息填写</h3></div>
				<x-input title="被帮教人"  v-model="theme" text-align="right" placeholder="请输入被帮教人" disabled="true"></x-input>
				<datetime title="日期选择" v-model="deductionDate" placeholder="请选择"></datetime>
			</group>
			<div class="diversion_results diversion_results_title ov">
				<div class="fl">反馈内容描述</div>
			</div>
			<div class="diversion_textarea">
				<textarea placeholder="请输入要反馈的内容"></textarea>
			</div>
				...
				<ul>
					<li>
						<router-link to="/phome/mindTestResult">
							<div class="adjusted_icon"><img src="../../../../assets/processing_true.png" /></div>
					...
					<li>
						<router-link to="/phome/mindTestResult">
							<div class="adjusted_icon"><img src="../../../../assets/processing_false.png" /></div>
							<div class="ov adjusted_info">
								<div class="fl adjusted_time">2018-02-02</div>
								<div class="fr adjusted_btn">详细结果</div>
							</div>
