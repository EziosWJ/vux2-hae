<template>
	...
	<div class="evaluation_out leave_out">
		<div class="evaluation_banner">
			<img src="../../../assets/risk_banner.jpg" />
		</div>
		<div class="evaluation_tab">
			<ul>
				<li @click="active=0" :class="{'active':active==0}">新建评估</li>
				<li @click="active=1" :class="{'active':active==1}">评估记录</li>
			</ul>
		</div>
		<div class="evaluation_content " v-show="active==0">			
			<group label-width="5em">
				<div class="diversion_results"><h3>信息填写</h3></div>
				<popup-picker title="被评估人" :data="tutoredPersonsList" v-model="tutoredPersons" placeholder="请选择"></popup-picker>
				<popup-picker title="评估人" :data="channelPeopleList" v-model="channelPeople" placeholder="请选择"></popup-picker>
				<datetime title="日期选择" v-model="deductionDate" placeholder="请选择"></datetime>
			</group>
			<div class="diversion_results diversion_results_title ov">
				<div class="fl">评估结果</div>
				<div class="fr ov diversion_results_list">
					<ul>
						<li :class="{'active':diversionResultsList==0}" @click="diversionResultsList=0">良好</li>
						<li :class="{'active':diversionResultsList==1}" @click="diversionResultsList=1">一般</li>
						<li :class="{'active':diversionResultsList==2}" @click="diversionResultsList=2">不合格</li>
					</ul>
				</div>
			</div>
		...
		<div class="evaluation_content evaluation_content2" v-show="active==1">
			...
			<div class="adjusted_list">
				<ul>
					<li>
						<router-link to="/phome/mindTestResult">
							...
							<div class="adjusted_main">
								<div class="adjusted_text">被评估人：李杰</div>
					...
					<li>
						<router-link to="/phome/mindTestResult">
							<div class="adjusted_icon"><img src="../../../assets/risk_icon3.png" /></div>
							<div class="adjusted_main">
								<div class="adjusted_text">被评估人：李杰</div>
								<div class="adjusted_name color_999">评估人：李杰</div>
							</div>
