<template>
	...
	<div class="evaluation_out leave_out">
		<div class="evaluation_banner">
			<img src="../../../../assets/community_banner.jpg" />
		</div>
		<div class="evaluation_tab">
			<ul>
				<li @click="active=0" :class="{'active':active==0}">新建活动</li>
				<li @click="active=1" :class="{'active':active==1}">服务记录</li>
			</ul>
		</div>
		<div class="evaluation_content " v-show="active==0">			
			<group label-width="5em">
				...
				<popup-picker title="目标单位" :data="communityList" v-model="community" placeholder="请选择"></popup-picker>
				<datetime title="时间" v-model="deductionDate" placeholder="请选择"></datetime>
			</group>
			<div class="diversion_results diversion_results_title ov">
				<div class="fl">服务内容</div>
			</div>
				...
				<ul>
					<li>
						<div class="persuasion_top ov">
							<div class="fl persuasion_name">去棉麻厂社区服务</div>
							<div class="fr persuasion_by_name">被帮教人：李杰</div>
						</div>
