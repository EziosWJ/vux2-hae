	...
	<div>
			...
			<ul>
					...
					<div class="helpers_main radius10">
						<router-link to="/inspectInfo">
							<div class="b_bom_x pdb20 ov">
								<div class="fl f28 port">检察官001</div>
				...
				<li class="mt20 box_shadow pd20 radius10">
					<div class="helpers_main radius10">
						<router-link to="/inspectInfo">
							<div class="b_bom_x pdb20 ov">
								<div class="fl f28 port">检察官002</div>
								<div class="fr small_btn">查看</div>
							</div>
							<div class="mt20 ov text_center">
				...
				<li class="mt20 box_shadow pd20 radius10">
					<div class="helpers_main radius10">
						<router-link to="/inspectInfo">
							<div class="b_bom_x pdb20 ov">
								<div class="fl f28 port">检察官003</div>
								<div class="fr small_btn">查看</div>
							</div>
							<div class="mt20 ov text_center">
			...
			<ul>
				<li class="mt20 box_shadow pd20 radius10">
					<div class="helpers_main radius10">
						<router-link to="/helpersInfo">
							<div class="b_bom_x pdb20 ov">
								<div class="fl f28 port">帮教人001</div>
								<div class="fr small_btn">查看</div>
							</div>
							<div class="mt20 ov text_center">
								<div class="helpers_main_info fl f26 ">帮教中3</div>
				...
				<li class="mt20 box_shadow pd20 radius10">
					<div class="helpers_main radius10">
						<router-link to="/helpersInfo">
							<div class="b_bom_x pdb20 ov">
								<div class="fl f28 port">帮教人002</div>
								<div class="fr small_btn">查看</div>
							</div>
							<div class="mt20 ov text_center">
								<div class="helpers_main_info fl f26 ">帮教中6</div>
				...
				<li class="mt20 box_shadow pd20 radius10">
					<div class="helpers_main radius10">
						<router-link to="/helpersInfo">
							<div class="b_bom_x pdb20 ov">
								<div class="fl f28 port">帮教人003</div>
								<div class="fr small_btn">查看</div>
							</div>
							<div class="mt20 ov text_center">
								<div class="helpers_main_info fl f26 ">帮教中5</div>
		...
		<div class="by_help_out pdlr20 bg_fff ov" v-show="current==2">
			<div class="by_help_box mt20 box_shadow radius10 pr by_help_box2">
				...
				<ul class="ov">
					<li><div class="by_help_list"><router-link to="/fixedScheme">12001</router-link></div></li>
					<li><div class="by_help_list"><router-link to="/fixedScheme">12002</router-link></div></li>
					<li><div class="by_help_list"><router-link to="/fixedScheme">12003</router-link></div></li>
					<li><div class="by_help_list"><router-link to="/fixedScheme">12004</router-link></div></li>
					<li><div class="by_help_list"><router-link to="/fixedScheme">12005</router-link></div></li>
					<li><div class="by_help_list"><router-link to="/fixedScheme">12006</router-link></div></li>
					<li><div class="by_help_list"><router-link to="/fixedScheme">12007</router-link></div></li>
				</ul>
			</div>
			<div class="by_help_box mt20 box_shadow radius10 pr by_help_box3">
				<img class="by_help_icon" src="../../assets/a003.png"/>
				<ul class="ov">
					<li><div class="by_help_list"><router-link to="/seeProgramme">12008</router-link></div></li>
					<li><div class="by_help_list"><router-link to="/seeProgramme">12009</router-link></div></li>
					<li><div class="by_help_list"><router-link to="/seeProgramme">12010</router-link></div></li>
					<li><div class="by_help_list"><router-link to="/seeProgramme">12011</router-link></div></li>
					<li><div class="by_help_list"><router-link to="/seeProgramme">12012</router-link></div></li>
					<li><div class="by_help_list"><router-link to="/seeProgramme">12013</router-link></div></li>
					<li><div class="by_help_list"><router-link to="/seeProgramme">12014</router-link></div></li>
				</ul>
			</div>
			<div class="by_help_box mt20 box_shadow radius10 pr by_help_box4">
				<img class="by_help_icon" src="../../assets/a004.png"/>
				<ul class="ov">
					<li><div class="by_help_list"><router-link :to="{path:'/seeResult',query:{type:'1'}}">12015</router-link></div></li>
					<li><div class="by_help_list"><router-link :to="{path:'/seeResult',query:{type:'1'}}">12016</router-link></div></li>
					<li><div class="by_help_list"><router-link :to="{path:'/seeResult',query:{type:'1'}}">12017</router-link></div></li>
					<li><div class="by_help_list"><router-link :to="{path:'/seeResult',query:{type:'1'}}">12018</router-link></div></li>
					<li><div class="by_help_list"><router-link :to="{path:'/seeResult',query:{type:'1'}}">12019</router-link></div></li>
					<li><div class="by_help_list"><router-link :to="{path:'/seeResult',query:{type:'1'}}">12020</router-link></div></li>
					<li><div class="by_help_list"><router-link :to="{path:'/seeResult',query:{type:'1'}}">12021</router-link></div></li>
					<li>
